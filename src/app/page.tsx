  ...
  return (
    <>
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative overflow-hidden min-h-[90vh] flex flex-col justify-center w-full">
          ...
          <div className="relative w-full max-w-3xl mx-auto px-5 pt-20 sm:pt-28 pb-12 z-10 overflow-hidden">
            ...
            >
              <div className="relative group cursor-default">
                ...
                <div className="relative flex items-center gap-2 px-4 py-2 rounded-full
                  ...
                  <span className="hidden sm:inline-flex items-center gap-1 text-xs font-bold text-accent border-l border-white/20 pl-2 ml-1">
            ...
            <motion.h1
              ...
              className="text-center font-jakarta font-black text-[2.25rem] sm:text-6xl md:text-7xl
                         leading-[1.15] tracking-tight text-white mb-6 drop-shadow-xl"
            >
              Cek Hoaks,{" "}
            ...
            <motion.p
              ...
              className="text-center text-sm sm:text-lg text-text-muted leading-relaxed max-w-xl mx-auto mb-10 px-2"
            >
